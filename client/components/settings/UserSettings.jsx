...
const ProfileSettings = () => {
    ...
    const handleClick = async () => {
        try {
            ...
            // Optionally, you might want to notify the user here.
        }
    };
    ...
    return (
        <div className='bg-gray-900'>
            ...
            <div className='bg-black h-screen overflow-y-scroll flex flex-col items-center text-center text-white p-8 pt-32'>
                <img className='rounded-full w-20 h-20 mb-4' src="images/defaultUser.png" alt="Profile" />
                ...
                <div className='mb-4 w-full max-w-[350px]'>
                    ...
                    <div className='flex flex-col gap-3 bg-gray-900 p-4 rounded-xl'>
                        <div className='w-full flex justify-between items-center gap-3 border-b border-gray-700 pb-3'>
                        ...
                        <div className='w-full flex flex-col gap-3 border-b border-gray-700 pb-3'>
                            <div className='flex items-center gap-3'>
                                <img className='rounded-full w-6 h-6' src="images/defaultUser.png" alt="Change profile picture" />
                                <div className='text-md text-white'>Change Profile Picture</div>
                            </div>
                            <div className='w-full flex justify-center items-center p-4 border-2 border-dashed border-gray-600 rounded-lg text-gray-400'>
                                Drag & Drop your image here or click to upload -- in development.
                            </div>
                        </div>
                        <div className='w-full flex justify-between items-center gap-3'>
                            ...
                            <button
                                className='text-md text-white bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-md'
                                onClick={handleClick}
                            >
                                Logout
                            </button>
